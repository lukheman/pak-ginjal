...
<div class="mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
    <div>
        <h1 class="text-2xl font-bold text-slate-800">Hasil Diagnosa</h1>
        <p class="text-slate-500 text-sm mt-1">Detail perhitungan Certainty Factor (CF) berdasarkan gejala yang dipilih.</p>
    </div>
    <div class="flex items-center gap-3">
        <a href="{{ route('konsultasi.cetak', $riwayat->id) }}" class="inline-flex items-center px-4 py-2 bg-red-600 border border-transparent rounded-lg font-medium text-white hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 shadow-sm text-sm transition-all">
            <!-- PDF Icon -->
            <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 21h10a2 2 0 002-2V9.414a1 1 0 00-.293-.707l-5.414-5.414A1 1 0 0012.586 3H7a2 2 0 00-2 2v14a2 2 0 002 2z"></path>
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 13h2m0 0h2m-2 0v4m-4 0h8"></path>
            </svg>
            Cetak Hasil PDF
        </a>
        <a href="{{ route('konsultasi.index') }}" class="inline-flex items-center px-4 py-2 bg-white border border-slate-300 rounded-lg font-medium text-slate-700 hover:bg-slate-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 shadow-sm text-sm transition-all">
                ...
                <ul class="divide-y divide-slate-100">
                    ...
                    <li class="px-4 py-3 hover:bg-slate-50 flex items-start">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-slate-500 mt-0.5">CF User: <span class="font-semibold text-blue-600">{{ $gejalaUser[$g->id] }}</span></p>
                        </div>
                    </li>
                    @endforeach
                </ul>
